...
<head>
    ...
    <title>Formulaire de supprission</title>
</head>
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <img src="assets/img/<?php echo $disc_picture ?>" name="picture" alt="" height="450">


                </div>
                <div class="mb-3">
                    <input type="submit" class="btn btn-primary" value="Supprimer" name="supprimer"></input>
