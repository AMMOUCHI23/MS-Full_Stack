...
<body>
    ...
    */
     // Les classes PDO
     /*PDO propose trois classe
     1. La classe PDO : La classe de base qui représente une connexion à une base de données. 
    
     2. La classe PDOStatement: Cette classe représente la requete préparée et ses résultats
     3. La classe PDOException: Cette classe représente les exceptions lancées par PDO 
